...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const url = `https://api.themoviedb.org/3/discover/movie?api_key=${config.tmdbApiKey}&language=tr-TR&sort_by=popularity.desc&vote_average.gte=5&include_video=true&page=${randomPage}`;
        ...
        try {
            ...
            const trailerUrl = `https://api.themoviedb.org/3/movie/${randomMovie.id}/videos?api_key=${config.tmdbApiKey}&language=en-US`;
